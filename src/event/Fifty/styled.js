...
export const Wrapper = styled.div`
	background: url('assets/clf-bg-fifty.png') no-repeat;
	background-position: top center;
	background-size: 100%;
	padding-top: 35%;
	position: relative;
    ${media.phone`
        background: url('assets/clf-bg-small-fifty@2x.png') no-repeat;
        background-size: 100%;
        padding-top: 95%;
	`}
`;
...
export const Table = styled.table`
    ...
    & th {
        ...
        :nth-child(3) {
            background-color: #a97e32;
        }
        :nth-child(4) {
            background-color: #9b7631;
        }
    }
    & td {
        padding: 8px;
